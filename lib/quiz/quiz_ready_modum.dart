...
//
// class QuizReadyModum extends StatelessWidget {
//
...
//
//     print(QuizController.to.is_visible_count_down.value);
...
//               .where('state', isEqualTo: 'ready').where('quiz_type', isEqualTo: '모둠').snapshots(),
...
//               QuizController.to.createQuestionList(); /// 문제를 stream하지 않고 list에서 바로 부르기 위해
//
