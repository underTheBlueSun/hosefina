...
import 'package:hosefina/controller/coupon_controller.dart';
...
class CouponMainTeacher extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          Text('학생들이 구매한 쿠폰 리스트', style: TextStyle(fontFamily: 'Jua', color: Colors.white),),
